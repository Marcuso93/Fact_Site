...
function Header({ showForm, setShowForm }) {
  const appTitle = "Some Facts to Share";
  return (
...
function NewFactForm({ setFacts, setShowForm }) {
  ...
  async function handleSubmit(e) {
    ...
    if (text && ValidHttpUrl(source) && category && textLength <= 200) {
      setIsUploading(true);
...
function FactList({ facts, setFacts }) {
  ...
  return (
    <section>
      ...
      <p>There are {facts.length} facts in this category. Add your own fact!</p>
    </section>
  );
}
